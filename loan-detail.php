...
$sel = "select * from loan-detail set amnt='$amnt',acno='$accno',cname='$name',dtype='$dptype'";
$Rsc = mysqli_query($con,$Ins) or die(mysqli_error());

header("location:loan-detail.php?msg=succ");

}

if($Id!='')
{
  $Del = "select * from loan-detail where id='$Id'";
...
<form>
<fieldset>
<legend><span class="number">1</span> loan-detail</legend>
<input type="text" name="cname" placeholder="Customer name *">

<input type="text" name="accno" placeholder="Account No. *">
<input type="text" name="address" placeholder="Address *">

<input type="text" name="dptype" placeholder="loan-detail type *">

<input type="text" name="amnt" placeholder="Amount *">
<input type="text" name="bkdtl" placeholder="Bank detail *">
...
<input type="submit" name="submit" value="Submit" onClick="validation();">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="loan-detailID">
