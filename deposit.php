...
$Ins = "insert into deposit set amnt='$amnt',acno='$accno',LName='$LName',dtype='$dptype'";
$Rsc = mysqli_query($con,$Ins) or die(mysqli_error());

header("location:deposit.php?msg=succ");

}

if($Id!='')
{
  $Del = "select * from deposit where id='$Id'";
...
<form>
<fieldset>
<legend><span class="number">1</span> Deposit amount</legend>
<input type="text" name="accno" placeholder="Account No. *">
<input type="text" name="dptype" placeholder="Deposit type *">
...
<input type="submit" name="submit" value="Submit" onClick="validation();">
  ...
  <div class="form-group">
    <label class="control-label col-sm-2" for="depositID">
